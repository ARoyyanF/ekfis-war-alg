            ...
            {mahasiswaData.data && (
              <div className="flex flex-row items-center gap-5">
                <div className="flex flex-col text-right">
                  <p className="text-gray-800 mb-1 text-base font-medium">{mahasiswaData.data.name}</p>
                  <p className="text-gray-700 text-sm">{mahasiswaData.data.nim}</p>
                </div>
                <Button
                  type="button"
                  variant="destructive"
